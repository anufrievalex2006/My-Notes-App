...
public class AuthController {
    ...
    public ResponseEntity<TokenResponse> register(@Valid @RequestBody RegisterDto req) {
        return ResponseEntity.ok(service.register(req));
    }
    @PostMapping("/login")
    public ResponseEntity<TokenResponse> login(@Valid @RequestBody LoginDto req) {
